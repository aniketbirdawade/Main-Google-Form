...
function openCreateForm() {
    var popup = window.open('create_form.jsp', 'createFormPopup', 
    ...
    // Check every 2 seconds if the popup is closed → refresh dashboard if yes
...
<div class="top-actions">
    <a class="create" onclick="openCreateForm(); return false;">+ Create New Form</a>
</div>
