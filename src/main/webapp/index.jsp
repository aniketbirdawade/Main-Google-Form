...
<head>
    ...
    <style>
        ...
        .container { width: 80%; margin: 30px auto; background: white; padding: 20px; border-radius: 10px; box-shadow: 0px 0px 10px rgba(0,0,0,0.1); }
        table { width: 100%; border-collapse: collapse; margin-top: 20px; }
        th, td { padding: 12px; border-bottom: 1px solid #ddd; text-align: left; }
        th { background-color: #4CAF50; color: white; }
        tr:hover { background-color: #f1f1f1; }
        .actions a { text-decoration: none; color: white; padding: 6px 10px; border-radius: 5px; margin-right: 5px; }
        .add { background-color: #2196F3; }
        .view { background-color: #4CAF50; }
        .create { background-color: #ff9800; padding: 10px 15px; border-radius: 5px; color: white; text-decoration: none; }
        .top-actions { text-align: right; }
    </style>
</head>
<body>
<header>
    🧩 Google Form Builder – Admin Dashboard
</header>
